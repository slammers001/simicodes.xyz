...
(function() {
    ...
    posthog.init('phc_dOBViKPhL2wwSDvkWprVr9vmD5L5303U10sVxcqda3T', { //it's the public api key, so if you would do anything it would only be sending fake events which i dont care about
